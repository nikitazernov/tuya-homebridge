...
class ActuatorAccessory extends BaseAccessory {
  ...
  refreshAccessoryServiceIfNeed(statusArr, isRefresh) {
    ...
    for (var statusMap of statusArr) {
      ...
      this.normalAsync(Characteristic.TargetHeaterCoolerState, Characteristic.TargetHeaterCoolerState.HEAT)
      this.normalAsync(Characteristic.CurrentHeaterCoolerState, Characteristic.CurrentHeaterCoolerState.HEAT)
      ...
      if (statusMap.code === 'temp_set') {
        ...
        if (!this.temp_set_range) {
            this.temp_set_range = { 'min': 10, 'max': 38 }
        }
        this.normalAsync(Characteristic.TargetTemperature, this.tempsetMap.value/10, {
...
module.exports = ActuatorAccessory;